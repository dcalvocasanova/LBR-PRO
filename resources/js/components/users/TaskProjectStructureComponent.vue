      ...
      <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header border-bottom-0">
            <h2 class="modal-title" @click="saveLevel()" id="LevelModalOptions">Seleccione el nivel para agregar funciones</h2>
                    ...
                    <div class="tree-viewer">
                      <tree-menu
                        ...
                        :showUserFunctionsEditor="showAsUserFunctionsEditor"
            						@create-user-function="CreateMacroprocess"
            						@modify-user-function="CreateMacroprocess"
                      >
                      </tree-menu>
                    </div>
                  </div>
