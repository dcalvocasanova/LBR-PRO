  ...
  <div class="container container-project">
    <div class="col-12">
      <div class="row">
        ...
        <div class="col-md-4" v-if="showCompetenceType">
          <div class="row">
            <div class="col-12">
              <div class="form-group">
...
export default {
  ...
  data() {
    return{
      ...
      levelPicked:'',
      productPicked:'',
      CompetencePicked:'Planear',
      showOptions:false,
      showProductType:false,
      showCompetenceType:false,
      showUserType:false,
      showUser:false,
      showData:false,
      showGraphics:false,
  ...
  methods:{
    ...
    showStrutureInformation(){
      ...
      this.showCompetenceType=false
      this.showUserType=false
    },
    showCompetence(){
      this.loadCatalogCompetence()
      this.showCompetenceType=true
      this.showProductType=false
      this.showUserType=false
    },
    showUsers(){
    ...
    selectByProduct(){
      let me = this
      axios.get('/grafica/competencias/productos/', {
        params: {
          project_id: me.projectPickedId,
      ...
      .then(response => {
        ...
        this.tipo = "Competencias por "+product
        this.dataToShowInGraph =  response.data
      });
    },
    selectByLevel(){
      let me = this
      axios.get('/grafica/competencias/niveles/', {
        params: {
          project_id: me.projectPickedId,
      ...
      .then(response => {
        this.tipo = "Competencias por nivel: "+me.levelPicked
        this.dataToShowInGraph =  response.data
      });
    },
    selectByCompetence(){
      let me = this
      axios.get('/grafica/competencias/competencias/', {
        params: {
          project_id: me.projectPickedId,
          competence: me.CompetencePicked
        }
      })
      .then(response => {
