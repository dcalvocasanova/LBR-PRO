      ...
      <div class="row">
        ...
        <div class="col-md-4" v-if="showOptions">
          <div class="lbpradio">
              ...
              <div class="lbpradio-danger">
                  <input @click="showRisk" type="radio" name="radio" id="radio3"  v-model="checks[2]" value="2" />
                  <label for="radio3">Riesgo</label>
              </div>
              <div class="lbpradio-danger">
                  <input @click="showDataRisk" type="radio" name="radio" id="radio4"  v-model="checks[3]" value="3" />
        ...
        <div class="col-md-4" v-if="showRiskType">
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                <label class="bmd-label-floating">Por riesgos</label>
                <div class="form-group">
                  ...
                  <treeselect
                    ...
                    />
                    <br>
                    <button @click="selectByRisk" type="button" name="button">buscar</button>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods:{
    ...
    showStrutureInformation(){
      ...
      this.showRiskType=false
      this.showUserType=false
    },
    showRisk(){
      this.loadCatalogRisk()
      this.showRiskType=true
      this.showProductType=false
      this.showUserType=false
    },
    showUsers(){
    ...
    selectByProduct(){
      let me = this
      axios.get('/grafica/riesgo/productos/', {
        params: {
          project_id: me.projectPickedId,
      ...
      .then(response => {
        ...
        this.tipo = "riesgos por "+product
        this.dataToShowInGraph =  response.data
      });
    },
    selectByLevel(){
      let me = this
      axios.get('/grafica/riesgo/niveles/', {
        params: {
          project_id: me.projectPickedId,
      ...
      .then(response => {
        this.tipo = "Riesgos por nivel: "+me.levelPicked
        this.dataToShowInGraph =  response.data
      });
    },
    selectByRisk(){
      let me = this
      axios.get('/grafica/riesgo/', {
        params: {
          project_id: me.projectPickedId,
          risk: me.RiskPicked
        }
      ...
      .then(response => {
        this.tipo = "Tareas por riesgo "
        this.dataToShowInGraph =  response.data
      });
    },
    getUserData(user){
      let me = this
      axios.get('/grafica/riesgo/usuario/', {
        params: {
          user_id: user.id
        }
      })
    ...
    getTableData(){
      let me = this
      axios.get('/grafica/riesgo/datos/', {
        params: {
          project_id: me.projectPickedId
        }
      })
      .then(response => {
        if(Object.keys(response.data.content).length > 0){
          this.showNodata=false
          this.tableName = "Datos de usuarios, tareas y riesgos"
