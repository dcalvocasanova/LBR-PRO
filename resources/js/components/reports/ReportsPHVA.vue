      ...
      <div class="row">
        ...
        <div class="col-md-4" v-if="showOptions">
          <div class="lbpradio">
              ...
              <div class="lbpradio-danger">
                  <input @click="showPHVA" type="radio" name="radio" id="radio3"  v-model="checks[2]" value="2" />
                  <label for="radio3">PHVA</label>
              </div>
              <div class="lbpradio-danger">
                  <input @click="showDataPHVA" type="radio" name="radio" id="radio4"  v-model="checks[3]" value="3" />
        ...
        <div class="col-md-4" v-if="showPHVAType">
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                <label class="bmd-label-floating">Por PHVA</label>
                <div class="form-group">
...
export default {
  ...
  methods:{
    ...
    showStrutureInformation(){
      ...
      this.showPHVAType=false
      this.showUserType=false
    },
    showPHVA(){
      this.loadCatalogPHVA()
      this.showPHVAType=true
      this.showProductType=false
      this.showUserType=false
    },
    showUsers(){
    ...
    selectByProduct(){
      let me = this
      axios.get('/grafica/phva/productos/', {
        params: {
          project_id: me.projectPickedId,
      ...
      .then(response => {
        ...
        this.tipo = "PHVA por "+product
        this.dataToShowInGraph =  response.data
      });
    },
    selectByLevel(){
      let me = this
      axios.get('/grafica/phva/niveles/', {
        params: {
          project_id: me.projectPickedId,
      ...
      .then(response => {
        this.tipo = "PHVA por nivel: "+me.levelPicked
        this.dataToShowInGraph =  response.data
      });
    },
    selectByPHVA(){
      let me = this
      axios.get('/grafica/phva/phva/', {
        params: {
          project_id: me.projectPickedId,
          phva: me.phvaPicked
        }
    ...
    getTableData(){
      ...
      .then(response => {
        if(Object.keys(response.data.content).length > 0){
          this.showNodata=false
          this.tableName = "Datos de usuarios, tareas y PHVA"
