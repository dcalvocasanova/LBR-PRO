    ...
    <div class="row justify-content-center">
        ...
        <div class="col-4 col-xs-6">
          <div class="card border-success mx-sm-1 p-3">
            <a href="/gestionar-catalogos-tareas">
              <div class="card border-success shadow text-success p-3 my-card"><span class="fas fa-tasks" aria-hidden="true"></span></div>
              <div class="text-info text-center mt-3"><h4> </h4></div>
              <div class="text-success text-center mt-2 d-none d-md-block"><h5>Tareas</h5></div>
            </a>
          </div>
        </div>
    </div>
