      ...
      <div class="col-md-12">
        <div class="card card-plain">
          <div class="card-header card-header-primary">
            <div class="row">
              <div class="col-10">
                <h3 class="card-title mt-0"> Lista de variables sobre tiempos de ajuste</h3>
              </div>
              <div class="col-2" data-toggle="tooltip" data-placement="bottom" title="Agregar nueva variable">
...
export default {
  ...
  methods:{
    getResults(page = 1) {
      axios.get('/variables-tiempos-ajuste?page=' + page)
      .then(response => {
    ...
    getVaraibles(){
        let me =this;
        me.clearFields();
        axios.get('/variables-tiempos-ajuste')
