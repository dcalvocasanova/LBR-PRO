      ...
      <div class="col-md-12">
        <div class="card card-plain">
          <div class="card-header card-header-primary">
            <div class="col-md-8">
                <h3 class="card-title mt-0"> Lista de Objetivos</h3>
            </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            saveObjective(){
                let me =this;
                this.form.post('/objetivos/guardar')
                .then(function (response) {
                    me.salir();
                    me.getVaraibles();// show all users
                    toast.fire({
                      type: 'success',
                      title: 'Objetivo registrada con éxito'
                    });
                })
                .catch(function (error) {
                    console.log(error);
            ...
            updateObjective(){
                let me = this;
                this.form.put('/objetivos/actualizar')
                .then(function (response) {
                   toast.fire({
                    type: 'success',
                    title: 'Objetivo actualizada con éxito'
                   });
            ...
            loadFieldsUpdate(Objective){
              ...
              me.title="Actualizar información de la Objetivo";
            ...
            deleteObjective(Objective){
              ...
              swal.fire({
                ...
                text: "Esta acción no se puede revertir, Está a punto de eliminar una Objetivo",
                type: 'warning',
              ...
              .then((result) => {
                if (result.value) {
                  axios.delete('/objetivos/borrar/'+Objective.id)
                  .then(function (response) {
                    swal.fire(
                      'Eliminado',
