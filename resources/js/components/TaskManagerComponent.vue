              ...
              <table class="table table-hover">
                <thead class="">
                  <tr>
                    ...
                    <th style="width:10%"> Frecuencia y tipo de trabajo </th>
                    <th style="width:10%"> Tiempo mínimo </th>
                    <th style="width:10%"> Tiempo nomal </th>
                    <th style="width:10%"> Tiempo máximo </th>
                  </tr>
                </thead>
                <tbody>
                    <tr v-for="task in Tasks" :key="task.id">
                      ...
                      <td>
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                          <div v-for="frecuency in Frecuencies":key="frecuency.id">
                            <button type="button" class="btn btn-primary"
                              data-toggle="tooltip" data-placement="top"
                              :title="frecuency.name" v-text="frecuency.name.substr(0,1)"></button>
                          </div>
                          <div class="btn-group" role="group">
                            <button id="btnGroupDropWorkType" type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              Impacto
                            </button>
                            <div class="dropdown-menu" aria-labelledby="btnGroupDropWorkType">
                              <div v-for="wt in WorkTypes":key="wt.id">
