      ...
      <div class="row">
          ...
          <div class="text-center">
            ...
            <div class="form-group">
              <label for="logo_project" class="col-sm-8 control-label file-uploader">
                <i class="fas fa-cloud-upload-alt"> Cambiar foto</i> </label>
              <div class="col-sm-12">
                  <input type="file" name="logo_project" id="logo_project" class="form-input" style='display: none;'>
              </div>
            </div>
          </div>
          </hr><br>
